...
This repository serves as a complete archive of the code and data used to investigate whether LLMs perform sarcasm detection better with System 1 (intuitive) or System 2 (deliberative) prompts and explores the improvement by Conservative Prompting.

What's Included in This Repository:

Code folder: Python scripts used to interface with the LLMs;
Raw Data Counts: The raw classification counts (True Positive, False Positive, True Negative, False Negative) for six LLMs across four prompts;
Data Analysis: Statistical evaluation and matrix.
